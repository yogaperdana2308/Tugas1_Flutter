...
class day18Drawer extends StatefulWidget {
  const day18Drawer({super.key});

  @override
  State<day18Drawer> createState() => _LatihanDrawerState();
}

class _LatihanDrawerState extends State<day18Drawer> {
  int selectedIndex = 0;
